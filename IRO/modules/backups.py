...
import IRO.modules.sql.notes_sql as sql
from IRO import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from IRO.__main__ import DATA_IMPORT
from IRO.modules.helper_funcs.chat_status import user_admin
from IRO.modules.helper_funcs.alternate import typing_action

# from IRO.modules.rules import get_rules
import IRO.modules.sql.rules_sql as rulessql

# from IRO.modules.sql import warns_sql as warnssql
import IRO.modules.sql.blacklist_sql as blacklistsql
from IRO.modules.sql import disable_sql as disabledsql

# from IRO.modules.sql import cust_filters_sql as filtersql
# import IRO.modules.sql.welcome_sql as welcsql
import IRO.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("IRO{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("IRO{}.backup".format(chat_id), "rb"),
    ...
    os.remove("IRO{}.backup".format(chat_id))  # Cleaning file
