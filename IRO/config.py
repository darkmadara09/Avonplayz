...
class Config(object):
    ...
    SQLALCHEMY_DATABASE_URL = "postgres://iarfggbc:Vxzh_kG7cxa1kHR5faxcd1kuA4R-UT9E@rosie.db.elephantsql.com/iarfggbc"  # needed for any database modules get it from https://www.elephantsql.com/
    LOAD = []
