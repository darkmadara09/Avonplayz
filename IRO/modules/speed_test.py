...
from IRO import DEV_USERS, dispatcher
from IRO.modules.disable import DisableAbleCommandHandler
from IRO.modules.helper_funcs.chat_status import dev_plus
...
def speedtestxyz_callback(update: Update, context: CallbackContext):
    ...
    if query.from_user.id in DEV_USERS:
        ...
        query.answer("ʏᴏᴜ ᴀʀᴇ ʀᴇQᴜɪʀᴇᴅ ᴛᴏ ᴊᴏɪɴ @IRO_AF ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ʙᴀʙʏ🥀.")
